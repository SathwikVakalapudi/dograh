...
// Hidden nav items — re-add these icons when restoring the commented sections below:
// AudioLines (Recordings), CircleDollarSign (Billing), Database (Files),
// FileText (Reports), Key (Developers), TrendingUp (Agent Runs), Wrench (Tools)
import {
  AlertTriangle,
  Brain,
  ChevronLeft,
...
const NAV_SECTIONS: SidebarNavSection[] = [
  ...
  // MANAGE section hidden for now — uncomment to restore.
  // {
  //   label: "MANAGE",
  //   items: [
  //     {
...
export function AppSidebar() {
  ...
  // "Hire an Expert" CTA hidden per deployment preference.
