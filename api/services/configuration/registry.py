...
class UltravoxRealtimeLLMConfiguration(BaseLLMConfiguration):
    ...
    language: str | None = Field(
        default=None,
        description=(
            "BCP-47 language code sent to Ultravox as languageHint (e.g. 'hi', 'en'). "
            "Guides speech recognition; leave unset to auto-detect (which can misfire "
            "per utterance on non-English audio)."
        ),
        json_schema_extra={
            "examples": OPENAI_REALTIME_LANGUAGES,
            "allow_custom_input": True,
